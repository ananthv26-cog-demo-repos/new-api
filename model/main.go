...
func migrateClickHouseLogDB() error {
	...
	// Tables created before the FireConnect client tag existed need the column added.
	if err := LOG_DB.Exec("ALTER TABLE logs ADD COLUMN IF NOT EXISTS client_tag String DEFAULT ''").Error; err != nil {
		return err
	}
